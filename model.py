...
class classifier():
    def __init__(self):
        self.dataset_path=load_path('./Lab/Data/data/npy')
    ...
    def train(self,iterations):
        ...
        for i in range(iterations):
            ...
            if (accuracy >= acc_max):
                torch.save(self.net,  './Lab/model/EEG_Best_Net_2_164.pth')
            self.test_accuracy.append(accuracy)
            print('accuracy:{0}%，{1}'.format(accuracy*100,i))   # 大括号中的数字代表format中的顺序
            if i%10==0:
